        ...
        <div class="main">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="li-content">
                                ...
                                <span>15862</span>
                                <span>82%</span>
                                <span><img src="@/assets/images/up.png" alt=""></span>
                            </div>
                        </li>
                        <li>
                            <div class="cicle"></div>
                        ...
                        <li>
                            ...
                            <div class="li-content">
                                ...
                                <span>15862</span>
                                <span>82%</span>
                                <span><img src="@/assets/images/down.png" alt=""></span>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="sale">
                <ul>
                    ...
                    <li>
                        <div class="showImg">
                            <img src="@/assets/images/mz.png" alt="">
                        </div>
                        <div class="data">
                            <span>产品C</span>
                            <span>12563</span>
...
<script src="@/jsdom/ecmain.js"></script>
<script src="@/jsdom/jquery-1.11.0.min.js"></script>
<script>
export default {
    data(){
        return{
